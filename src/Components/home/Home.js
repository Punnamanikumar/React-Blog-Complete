...
const Home = () => {
  ...
  useEffect(() => {
    axios
      .get("https://manikumar-react-blog-server.onrender.com/api/blog")
      .then((res) => {
        setHome(res.data);
      });
  }, []);
            ...
            {home
              ...
              .map((job) => (
                <Link to={`/jobs/${job.id}`} className="two">
                  ...
                  <div className="twot">
                    {" "}
                    Hyderabad: <br /> Good news for job seekers
                  </div>
                </Link>
              ))}
            {home
              ...
              .map((tec) => (
                <Link to={`/technology/${tec.id}`} className="three">
                  <img src={tec.img} alt="" />
                  <div className="threet">
                    {" "}
                    Samsung Galaxy <br /> S22 Series
                  </div>
                </Link>
              ))}
          </div>
                ...
                {home
                  ...
                  .map((latest) => (
                    ...
                    >
                      ...
                      <div className="c2h5 rc2h5">
                        <h5>{latest.date}</h5>
                      </div>
                      <div className="c1h7 rc1h7">
                        <h4>Category: {latest.category}</h4>
                      </div>
                    </Link>
                  ))}
